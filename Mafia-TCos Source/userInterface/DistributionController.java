...
public class DistributionController {
    @FXML
    public JFXRadioButton DistributionTool1;
    public JFXRadioButton DistributionTool2;
    public JFXRadioButton DistributionTool3;
    public JFXRadioButton DistributionTool4;
    public JFXButton distributionButton;
    ...
    {
        int s = crimeSize;
        buttons.add(DistributionTool1);
        buttons.add(DistributionTool2);
        buttons.add(DistributionTool3);
        buttons.add(DistributionTool4);
        int i = 0;
        while(i < 4)
        {
